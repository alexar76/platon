...
class Settings(BaseSettings):
    ...
    # CORS: comma-separated origins. Defaults to localhost only; set explicitly
    # in production via PLATON_CORS_ORIGINS (e.g. "https://magic-ai-factory.com").
    cors_origins: str = "http://localhost:9080,http://127.0.0.1:9080,http://localhost:8080,http://127.0.0.1:8080"
